function [IntanData] = read_Intan_RHD2000_file(varargin)
...
%% Attribution of fields to IntanData Structure %%
IntanData.amplifier_channels = amplifier_channels;
IntanData.amplifier_data = amplifier_data;
IntanData.aux_input_channels = aux_input_channels;
IntanData.aux_input_data = aux_input_data;
IntanData.isADC = ~isempty(board_adc_data);
IntanData.board_adc_data = board_adc_data;
IntanData.filename = fileName; 
IntanData.frequency_parameters = frequency_parameters;
IntanData.notes = notes;
IntanData.path = path;
%IntanData.reference_channel = reference_channel;
IntanData.spike_triggers = spike_triggers; 
IntanData.t_amplifier = t_amplifier; 
IntanData.t_aux_input = t_aux_input;
